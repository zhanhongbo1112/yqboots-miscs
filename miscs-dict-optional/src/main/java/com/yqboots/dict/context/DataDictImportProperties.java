...
/**
 * The {@code ConfigurationProperties} for Data Dictionary related functions.
 *
 * @author Eric H B Zhan
 * @since 1.0.0
 */
@ConfigurationProperties(prefix = "yqboots.dict.import")
public class DataDictImportProperties {
    /**
