...
/**
 * Controller for DataDict exporting.
 *
...
public class DataDictExportController {
    @Autowired
    private DataDictExportFacade dataDictExportFacade;
    ...
    public HttpEntity<byte[]> exports() throws IOException {
        final Path path = dataDictExportFacade.exports();
